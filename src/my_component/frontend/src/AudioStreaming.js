...
// ) {
// define("AudioStreaming", ["chalk", "stream", "node-record-lpcm16", "@google-cloud/speech"], async function(chalk, Writable, recorder, speech) {
define(function (require) {
  ...
  // Export the function or any other variables/methods
...
// streammain(...process.argv.slice(2));