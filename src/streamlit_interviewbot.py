...
class Interview():
    ...
    def _init_display(_self):
        ...
        with st.sidebar:
            ...
            switch = st.button("switch to text only session", key="switch_button", on_click=_self.text_session)
            #temporary button
            feedback =st.button("end session", key="feedback", on_click=_self.interview_feedback)
