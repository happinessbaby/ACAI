...
from backend.upgrade_resume import evaluate_resume, tailor_resume
...
class Dashboard():
    ...
    def display_tailoring(self, ):

        tailor_dict = self.get_dict("tailoring")
